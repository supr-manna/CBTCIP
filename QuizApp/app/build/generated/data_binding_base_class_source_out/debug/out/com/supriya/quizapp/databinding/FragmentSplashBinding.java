...
public final class FragmentSplashBinding implements ViewBinding {
  ...
  private FragmentSplashBinding(@NonNull ConstraintLayout rootView, @NonNull ImageView ivMainImage,
      @NonNull TextView tvFirstText) {
  ...
  public static FragmentSplashBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentSplashBinding((ConstraintLayout) rootView, ivMainImage, tvFirstText);
    }
